...
(function ($) {
  ...
  try {
    ...
    err_style =
      "#mc_embed_signup input.mce_inline_error { border-color:#6B0505; } #mc_embed_signup div.mce_inline_error { margin: 0 0 1em 0; padding: 5px 10px; background-color:#ffaa00; font-weight: bold; z-index: 1; color:#fff; }";
  }
